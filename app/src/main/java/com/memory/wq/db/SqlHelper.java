...
public class SqlHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE_FRIENDS = "create table " + AppProperties.TABLE_NAME_FRIEND + " (id integer primary key autoincrement,rela_id integer,chat_id integer,sender_id integer ,receiver_id integer,valid_msg varchar(255) ,status integer,create_at integer ,update_at integer)";
    ...
    private static final String CREATE_TABLE_GROUP = "create table " + AppProperties.TABLE_NAME_MESSAGE + "(_id integer primary key autoincrement,group_id integer, ownerId integer, create_at integer,update_at integer)";
